 ...
 *
 * @pre Cartelle assets/card/cards_assets/ e assets/img/ esistono con i PNG richiesti.
...
void CaricaTextureReali(void) {
    ...
    // Sfondo caricato dalla sottocartella assets/img/
    textureSfondo = LoadTexture("assets/img/sfondo.png");
