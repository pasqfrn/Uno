...
typedef struct {
    ...
    int id_carta_in_trascinamento;  /* Indice della carta trascinata (-1 = nessuna).
                                       NOTA (incapsulamento): il riferimento alla carta e'
                                       mantenuto come indice, MAI come puntatore a NodoCarta:
                                       la rappresentazione interna dell'ADT ListaCarte resta
                                       nascosta agli utilizzatori di StatoGioco. */
