...
echo ========================================
echo.
C:\msys64\ucrt64\bin\gcc.exe -std=c99 -Wall -Wextra -Ilib -Isrc -Itests -Itests/stubs tests/test_adt.c src/data_structures/stack.c src/data_structures/queue.c src/data_structures/list.c src/data_structures/bst.c src/data_structures/chat.c src/list.c src/game_logic.c src/game/deck.c -o tests/test_adt.exe -lm
if %errorlevel% neq 0 (
    color 0C
...
echo  COMPLETATO!
echo  - Gioco: game.exe
echo  - Test: tests/test_adt.exe  (171 test)
